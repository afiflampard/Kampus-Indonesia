...
$check_data = select($pdo,"SELECT * FROM `data_soal` WHERE `judul`='$judul' and `jenis_soal`='Private'  and `id`='1' "); 
$check_data->execute();
...
if($row_data >= 1){
	...
	if(!empty($soal_1)){
		...
		if($total_2 >= 1){$total_2 = $total_2-1;}
		if($total_3 >= 1){$total_3 = $total_3-1;}
		...
		(`pisah`,`password`,`masa_aktif`,`jenis_soal`,`judul`, `tanggal`, `harga`, `kode_soal`, `waktu_1`, `waktu_2`, `waktu_3`, `lulus_1`, `lulus_2`, `lulus_3`, `soal_1`, `soal_2`, `soal_3`,`nama_soal_1`, `nama_soal_2`, `nama_soal_3`, `kategori`) VALUES 
		('pisah','$password_soal','$masa_aktif','Private','$judul','$date','$harga','$kode','$waktu_1','$waktu_2','$waktu_3','$lulus_1','$lulus_2','$lulus_3','$total_1','$total_2','$total_3','$nama_soal_1','$nama_soal_2','$nama_soal_3','Soal Gratis') ");
...
<form method="post" enctype="multipart/form-data"> 
	...
	<br />
	<span> <b> Pisahkan Waktu </b> </span> 
	<select type="text" required class="form-control" name="pisah" value="" placeholder="Masukkan Judul Soal" >
	<option>Yes</option>
	<option>No</option>
	</select>
	...
	<span> <b> Password Soal </b> </span> 
	<input type="text" required class="form-control" name="password_soal" value="" placeholder="Masukkan Password Soal "    />
	<br />
	...
	<span> Soal <?php echo($i) ;  ?> </span>  
		<select type="text"   min="0"  class="form-control" name="nama_soal_<?php echo($i) ;  ?>" value="" 	>
		<option>TPA</option>
		<option>TBI</option>
		<option>TIU</option>
		<option>TKP</option>
