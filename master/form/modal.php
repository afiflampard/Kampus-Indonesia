...
<div class="modal fade" id="modal_delete" role="dialog" style="display: none; margin-top:0px;">
 <div class="modal-dialog"style="border-radius:0px !Important ">
   ...
   <div class="modal-dialog"style="border-radius:0px !Important ">
	   <div class="modal-content"style="border-radius:0px !Important ">
		   ...
		   <form method="post" enctype="multipart/form-data"> 
			  ...
			  <input type="text" required class="form-control" id="conf_name" name="data" value="" placeholder="Your Data "    />
			  <br />
  ...
  <script>
  function showresi(id,nama){
   $('#resi_id').val(id);
   $('#resi_name').val(nama);
   
   $('#modal_resi').modal('show'); 
  }
  function cancel_resi(){ $('#modal_resi').modal('hide'); }
  </script>
  
  <div class="modal fade" id="modal_resi" role="dialog" style="display: none; margin-top:0px;">
   <div class="modal-dialog"style="border-radius:0px !Important ">
	   <div class="modal-content"style="border-radius:0px !Important ">
		   <div class="modal-header" style="border-radius:0px !Important ">
			   <span class="modal-title">Anda Yakin Telah Mengirim Buku</span>
			   <button type="button" class="close" data-dismiss="modal">x</button>
		   </div>
		   <div class="modal-body">
		   <form method="post" enctype="multipart/form-data"> 
			  <span> Your Data </span> 
			  <input type="hidden" required class="form-control" id="resi_id" name="id" value="" placeholder=""    />
			  <input type="text" required class="form-control" id="resi_name" name="data" value="" placeholder="Your Data "    />
			  <br />
			  <span> Masukkan Resi Pelacakan </span> 
			  <input type="text" required class="form-control" name="resi" value="" placeholder=""    />
			  <br />
			  
			  <button type="submit" name="masukkan_resi" class="btn btn-primary" >Konfirmasi</button> 
		   </form>
		   </div> 
	   </div>
   </div>
