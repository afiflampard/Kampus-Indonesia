...
$check_title = select($pdo,"SELECT * FROM `footer` WHERE `title`='$title' "); 
$check_title->execute();
...
if($row_title >= 1){
	...
	eksekusi($pdo,"INSERT INTO `footer` (`title`,`content`) VALUES ('$title','$content') ");
	$alert = "success";
	$respon = "Footer Baru Sudah Dimasukkan";
...
<?php  if(!empty($alert)){ ?>
	...
	<span> Title </span> 
	<input type="text" required class="form-control" name="judul" value="" placeholder="Masukkan Judul Footer "    />
	<br />

	<span> Content  </span> 
	<link rel="stylesheet" href="assets/html5-editor/bootstrap-wysihtml5.css" />   
	<script src="assets/tinymce/tinymce.min.js"></script>
	<textarea id="mymce"  class="form-control" name="content"></textarea>
	<script>
	...
	<button type="submit" class="btn btn-success" name="new" >Masukkan Data Footer Baru</button>
