...
$id = in($_POST['id']);
eksekusi($pdo,"DELETE FROM `faq` WHERE `id`='$id' ");
}
...
<div class="card-block"><div class="table-responsive">
 ...
 "aoColumns": [
	...
	{ "mclass":"wall", "mData": "3", "mRender": function ( data, type, full ) {
	 ...
	 see = ' <a  href="?show=faq_edit&id='+data+'" class="btn btn-primary btn-xs btn-sm"    ><i class="fa fa-edit">  </i></a> ';
	 return hapus+see;
	 }} 
 ]
 } );
