...
<span style="font-size : 24px ; font-weight : bold; color:#f01479; " class="countdown">  <?php echo($waktu_soal) ;  ?> </span> </a> 
...
<div class="card-header"><h5>Page Active : <?php echo($data->nama_soal_1) ;  ?></h5></div>
...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 p-1  p-1 ">
<a class="btn btn-danger " style="width : 100%; color:white !important;"    > <span id="belum_1"> <?php echo($max_1) ;  ?> </span> Belum   </a>  
</div>
</div>
