<?php 
$check_inv = select($pdo,"SELECT * FROM `invoice_buku` WHERE  `user_id`='$user_id'  LIMIT 1 "); 
$check_inv->execute();
...
<div class="row">
	...
	<div class=""  align="right" >  
		<a class="btn btn-info" href="?show=buku_bukti&inv=<?php echo($data->invoice) ;  ?>"> Upload Bukti Pembayaran </a> 	
	</div>
