...
<?php 
	for ($i = 1; $i <= $max_2; $i++) {
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-2 p-1    " style="padding:3px !Important;">
			<a id="no_<?php echo($i) ;  ?>_2" onclick="go_page_2('<?php echo($i) ;  ?>')" class="btn btn-danger" style="width : 100%; color:white !important; padding:3px !Important; text-align:center; padding-top:7px !important; padding-bottom:7px !important;" > <?php echo($i) ;  ?> </a>  
		</div>
...
<a class="btn btn-success " style="width : 100%; color:white !important;"    > <span id="dijawab_2"> 0 </span>  Dijawab </a>  
</div>
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 p-1  p-1 ">
<a class="btn btn-danger " style="width : 100%; color:white !important;"    > <span id="belum_2"> <?php echo($max_2) ;  ?> </span> Belum   </a>  
</div>
</div>
